...
//SHOPKEEPER
//Todo: More stuff? I don't know
/datum/job/partisan/civilian/shopkeep
	title = "Shop Keeper"
	is_occupation = TRUE
	selection_color = "#530909"
	spawn_location = "JoinLateCivilianShopKeep"
	additional_languages = list( "Russian" = 10, "German" = 70)
	// AUTOBALANCE
	min_positions = 1
	max_positions = 1
...
/datum/job/partisan/civilian/shopkeep/equip(var/mob/living/carbon/human/H)
	if (!H)	return FALSE
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/laceup(H), slot_shoes)
	H.equip_to_slot_or_del(new /obj/item/clothing/glasses/regular(H), slot_l_store)
	H.equip_to_slot_or_del(new /obj/item/clothing/suit/chef/classic(H), slot_wear_suit)
	equip_random_civilian_clothing(H)
	H.add_note("Role", "You are the <b>[title]</b>. You run a grocery store.")
	H.setStat("strength", civ_stat())
	H.setStat("engineering", civ_stat())
	H.setStat("shotgun", civ_stat())
	H.setStat("medical", civ_stat())
