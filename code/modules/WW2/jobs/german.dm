...
#define GERMAN_XO_TITLE "Oberstleutnant"
...
/datum/job/german/squad_leader_sstv
	...
	en_meaning = "SS Totenkopfverb�nde Squad Leader"
	rank_abbreviation = "uscha"
	head_position = TRUE
	selection_color = "#4c4ca5"
	spawn_location = "JoinLateSS-Officer"
...
/datum/job/german/soldier_sstv
	...
	en_meaning = "SS Totenkopfverb�nde Soldier"
...
/datum/job/german/medic_sstv
	title = "SS-TV-Sanit�ter"
	en_meaning = "SS Totenkopfverb�nde Medic"
...
/datum/job/german/paratrooper_reichstag/equip(var/mob/living/carbon/human/H)
	...
	H.add_note("Role", "You are a <b>[title]</b>, a paratrooper from the 9th Fallschirmj�ger Division. Your job is to help any other units that need assistance.")
