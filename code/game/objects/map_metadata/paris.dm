...
/obj/map_metadata/paris
	ID = MAP_PARIS
	title = "Paris (125x125x2)"
	lobby_icon_state = "paris"
...
//		RESISTANCE)
	...
	songs = list(
	 "Depression Blues:1" = 'sound/music/depression_blues.ogg',
	 "Koop Island Blues:1" = 'sound/music/koopislandblues.ogg',
     "Dance Me To The End of Love:1" = 'sound/music/dance_me_to_the_end_to_love.ogg',
     "Relaxing Risk:1" = 'sound/music/relaxing_risk.ogg')

/obj/map_metadata/paris/germans_can_cross_blocks()
	return (processes.ticker.playtime_elapsed >= 72000 || admin_ended_all_grace_periods)

/obj/map_metadata/paris/soviets_can_cross_blocks()
	return (processes.ticker.playtime_elapsed >= 72000 || admin_ended_all_grace_periods)


/obj/map_metadata/paris/job_enabled_specialcheck(var/datum/job/J)
	. = TRUE
	if (istype(J, /datum/job/german))
		...
		if (istype(J, /datum/job/partisan/civilian/jewl))
			J.total_positions = 1
		if (istype(J, /datum/job/partisan/civilian/shopkeep))
			J.total_positions = 1
...
/obj/map_metadata/paris/announce_mission_start(var/preparation_time)
	world << "<font size=4>Résistants are hiding in Paris! The SS have been sent to hunt them down.<br>"

/obj/map_metadata/paris/reinforcements_ready()
	return (germans_can_cross_blocks() && soviets_can_cross_blocks())

/obj/map_metadata/paris/short_win_time(faction)
	return 1200

/obj/map_metadata/paris/long_win_time(faction)
	return 1200

var/no_loop_o = FALSE

/obj/map_metadata/paris/update_win_condition()
